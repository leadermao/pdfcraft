            ...
            <Card variant="default" className="p-6 bg-white/40 dark:bg-black/30 backdrop-blur-md border border-[hsl(var(--color-border))]/50 dark:border-zinc-850 rounded-[2rem] shadow-xl flex flex-col justify-between min-h-[380px]">
              <div className="space-y-6">
                <div className="border-b border-zinc-150 dark:border-zinc-800 pb-3 flex items-center gap-2">
                  ...
                  <h3 className="text-sm font-black text-[hsl(var(--color-foreground))] dark:text-zinc-200">{t('interactiveTocGenerator.optionsTitle')}</h3>
                </div>

                <div className="space-y-4 text-xs">
                  <div className="space-y-1.5">
                    <label className="text-[hsl(var(--color-muted-foreground))] font-bold">{t('interactiveTocGenerator.tocTitleLabel')}</label>
                    <input
                      type="text"
                      value={title}
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[hsl(var(--color-muted-foreground))] font-bold">{t('interactiveTocGenerator.insertPageLabel')}</label>
                    <input
                      type="number"
                      value={insertIndex}
