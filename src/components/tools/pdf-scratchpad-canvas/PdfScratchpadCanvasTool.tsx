          ...
          <div className="lg:col-span-8 space-y-4">
            <Card variant="outlined" className="p-6 bg-[hsl(var(--color-muted))] dark:bg-zinc-950/40 relative overflow-hidden rounded-[2rem] min-h-[380px] flex flex-col justify-between border-2 border-dashed border-[hsl(var(--color-border))] dark:border-zinc-800">
              ...
              <div className="flex-1 flex items-center justify-center p-6 perspective-[1000px]">
                <div className="flex items-center justify-center relative shadow-xl rounded-lg border border-[hsl(var(--color-border))] dark:border-zinc-800 bg-white dark:bg-zinc-900 overflow-hidden min-h-[220px]">
                  {/* Left normal page content */}
                  <div className="w-40 h-52 p-4 space-y-3 border-r border-[hsl(var(--color-border))] dark:border-zinc-800">
                    ...
                    <div className="w-full h-full relative p-3">
                      ...
                      {gridType === 'ruled' && (
                        <div className="absolute inset-0 flex flex-col justify-between py-4">
                          <div className="border-b border-[hsl(var(--color-border))] dark:border-zinc-800 h-0 w-full" />
                          <div className="border-b border-[hsl(var(--color-border))] dark:border-zinc-800 h-0 w-full" />
                          <div className="border-b border-[hsl(var(--color-border))] dark:border-zinc-800 h-0 w-full" />
                        </div>
                      )}
            ...
            <Card variant="default" className="p-6 bg-white/40 dark:bg-black/30 backdrop-blur-md border border-[hsl(var(--color-border))]/50 dark:border-zinc-850 rounded-[2rem] shadow-xl flex flex-col justify-between min-h-[380px]">
              <div className="space-y-6">
                <div className="border-b border-zinc-150 dark:border-zinc-800 pb-3 flex items-center gap-2">
                  ...
                  <h3 className="text-sm font-black text-[hsl(var(--color-foreground))] dark:text-zinc-200">{t('pdfScratchpadCanvas.optionsTitle')}</h3>
                </div>

                <div className="space-y-4 text-xs">
                  <div className="space-y-1.5">
                    <label className="text-[hsl(var(--color-muted-foreground))] font-bold">{t('pdfScratchpadCanvas.padPositionLabel')}</label>
                    <select
                      value={padPosition}
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[hsl(var(--color-muted-foreground))] font-bold">{t('pdfScratchpadCanvas.gridTypeLabel')}</label>
                    <select
                      value={gridType}
